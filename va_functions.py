...
def get_ll(sigma_mu_squared, sigma_theta_squared, sigma_epsilon_squared,
    ...
    if return_means:
        return -1 * ll / 2, h, h_sum, x_tilde, y_tilde, x_bar_tilde, y_bar_tilde, y_bar_bar, x_bar_bar
    else:
        return -1 * ll / 2
...
def get_grad_all(sigma_mu_squared, sigma_theta_squared, 
    ...
    _, h, h_sum, x_tilde, y_tilde, x_bar_tilde, y_bar_tilde, y_bar_bar, x_bar_bar = ll_vec_func(vec, True)
    ...
    return np.concatenate((gradient, grad_beta, grad_lambda_plus_beta, grad_alpha))


def get_grad_vec(vec, epsilon, ll_vec_func, start=0):
